<template>
    <li>
        ...
        <button @click="toggleFavotite">{{ isFavorite ? 'Unfavorite' : 'Favorite' }}</button>
        <button @click="toggleDetails">Show details</button>
        <button @click="$emit('my-delete', id)">Remove</button>
...
export default {
    ...
    emits: ['toggle-favorite', 'my-delete'],
    data() {
        return {
